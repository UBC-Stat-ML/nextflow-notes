...
@rem ##########################################################################
@rem
@rem  nf-monitor startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and NF_MONITOR_OPTS to pass JVM options to this script.
...
@rem Execute nf-monitor
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NF_MONITOR_OPTS%  -classpath "%CLASSPATH%" flows.Symlinks %*
...
:fail
rem Set variable NF_MONITOR_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%NF_MONITOR_EXIT_CONSOLE%" exit 1
exit /b 1
